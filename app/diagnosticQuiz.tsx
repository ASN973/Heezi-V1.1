...
return (
  <Text>Welcome to diagnostic quizz</Text>
)
...
// Pour que ce soit un diagnostic dynamique utilse un générateur pour parcourir les questions de manière séquentielle. Si le générateur est épuisé (plus de questions)
// Il marque le niveau comme complété et redirige vers la page de résultat.
// Utilise un array pour pouvoir générer les questions dynmaiquement